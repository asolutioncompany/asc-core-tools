 ...
 *
 * Features include basic security, managing autosaves and revisions, disabling autoupdate
 * emails, database maintenance, disabling all comments, and templating for quickly adding
 * encapsulated PHP, CSS, and JS customizations.
 *
